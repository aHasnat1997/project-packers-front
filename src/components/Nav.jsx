...
const Nav = ({ isOpen, setOpen }) => {
    ...
    return <nav className={`lg:bg-white w-full py-4 bg-tertiary`}>
        <div className='max-w flex lg:justify-between items-center gap-1 lg:gap-8'>
            ...
            {/* responsive nav part */}
            <div className={`lg:hidden min-w-screen flex items-center gap-2 duration-300 ${isOpen ? 'ml-[20rem]' : ''}`}>
                ...
                <Link to='/'><Logo isNav={true} /></Link>
                <SearchField placeholder={'Paste the URL of the product'} iconColor={'#F2C852'} fieldStyle='w-[8.5rem]' />
                {/* to-do: Modal */}
                <Link to='/auth/log-in' className='flex-1'>
                    <button className="btn-secondary py-[8px] px-[20px]">Log In</button>
                </Link>
            </div>
        </div>
            ...
            ${!isOpen ? '-ml-96' : ''}`}>
                ...
                <ul className="mt-8 flex flex-col gap-4">
                    ...
                    <li className="flex gap-2 items-center">
                        <span className="bg-tertiary rounded-full p-[6px]">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.1665 9.00375C14.1665 8.71567 14.1665 8.57167 14.2098 8.44333C14.3358 8.07037 14.668 7.92563 15.0008 7.77407C15.3748 7.60368 15.5618 7.51849 15.7472 7.5035C15.9576 7.48648 16.1683 7.53182 16.3482 7.63274C16.5866 7.76653 16.7528 8.02078 16.9231 8.22752C17.7093 9.18233 18.1023 9.65983 18.2461 10.1863C18.3622 10.6112 18.3622 11.0555 18.2461 11.4803C18.0363 12.2483 17.3736 12.892 16.883 13.4878C16.6321 13.7926 16.5066 13.945 16.3482 14.0339C16.1683 14.1348 15.9576 14.1802 15.7472 14.1632C15.5618 14.1482 15.3748 14.063 15.0008 13.8926C14.668 13.741 14.3358 13.5963 14.2098 13.2233C14.1665 13.095 14.1665 12.951 14.1665 12.6629V9.00375Z" stroke="#124E58" strokeWidth="1.5" />
                                <path d="M5.83317 9.00384C5.83317 8.64117 5.82299 8.31518 5.52976 8.06017C5.42311 7.96742 5.28171 7.90301 4.99893 7.77421C4.62485 7.60382 4.4378 7.51863 4.25247 7.50364C3.69643 7.45867 3.39727 7.83818 3.07661 8.22765C2.29046 9.1825 1.89739 9.65992 1.75355 10.1864C1.63749 10.6113 1.63749 11.0557 1.75355 11.4805C1.96334 12.2484 2.6261 12.8921 3.11668 13.488C3.42591 13.8636 3.72131 14.2063 4.25247 14.1633C4.4378 14.1483 4.62485 14.0631 4.99893 13.8928C5.28171 13.7639 5.42311 13.6995 5.52976 13.6068C5.82299 13.3518 5.83317 13.0258 5.83317 12.6631V9.00384Z" stroke="#124E58" strokeWidth="1.5" />
                                <path d="M4.1665 7.5C4.1665 4.73857 6.77818 2.5 9.99984 2.5C13.2215 2.5 15.8332 4.73857 15.8332 7.5" stroke="#124E58" strokeWidth="1.5" strokeLinecap="square" strokeLinejoin="round" />
                                <path d="M15.8335 14.167V14.8337C15.8335 16.3064 14.3411 17.5003 12.5002 17.5003H10.8335" stroke="#124E58" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </span>
                    ...
                    <li className="flex gap-2 items-center">
                        <span className="bg-tertiary rounded-full p-[6px]">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M11.6667 2.57918C11.2858 2.52701 10.8963 2.5 10.5 2.5C6.08173 2.5 2.5 5.85787 2.5 10C2.5 14.1422 6.08173 17.5 10.5 17.5C10.8963 17.5 11.2858 17.473 11.6667 17.4208" stroke="#124E58" strokeWidth="1.5" strokeLinecap="round" />
                                <path d="M17.4998 10.0003H9.1665M17.4998 10.0003C17.4998 9.41683 15.8379 8.3266 15.4165 7.91699M17.4998 10.0003C17.4998 10.5838 15.8379 11.6741 15.4165 12.0837" stroke="#124E58" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
