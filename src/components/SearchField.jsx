...
export const SearchField = ({ fieldStyle, placeholder, iconColor }) => {
    return <div className="relative">
        <svg className="stroke-secondary absolute top-[calc(50%-12px)] left-4" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
